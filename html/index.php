...
<?php
				...
				?>
					<tr>
						<td><a href="<?php echo PAGELINK_CONTACTSVIEW; ?>?i=<?php echo urlencode($contact["contact_id"]); ?>"><?php echo htmlentities(full_name($contact["first_name"], $contact["middle_name"], $contact["last_name"])); ?></a></td>
